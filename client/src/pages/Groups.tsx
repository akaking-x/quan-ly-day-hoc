...
export function Groups() {
  ...
  // Nhân bản nhóm - giữ lịch học, học phí, năm học - không giữ tên và học sinh
  const openDuplicateModal = (group: Group) => {
    setEditingGroup(null); // Đây là thêm mới, không phải chỉnh sửa
    setFormData({
      name: '', // Không giữ tên
      description: '',
      schoolYear: group.schoolYear,
      defaultFeePerSession: group.defaultFeePerSession.toString(),
      schedule: [...group.schedule], // Giữ lịch học
    });
    setDuplicateSchedule(false);
    setWeeksToGenerate(4);
    setScheduleDirection('forward');
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button
                      ...
                      className="p-2 text-purple-600 dark:text-purple-400 hover:bg-purple-100 dark:hover:bg-purple-900/50 rounded-xl transition-colors"
                      title="Nhân bản"
                    >
